    ...
    <>
      ...
      >
        <div className="max-w-[1200px] mx-auto px-6 h-full flex items-center justify-between">
          <Link href="/" className="text-lg font-bold tracking-[-0.3px] z-10">
          ...
          <button
            ...
            className="md:hidden flex flex-col gap-[5px] p-2 bg-transparent border-none cursor-pointer z-[1001]"
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed top-[70px] left-0 right-0 bottom-0 z-[1000] flex flex-col bg-[rgba(10,10,26,0.98)] backdrop-blur-xl transition-transform duration-300 ease-in-out ${
