...
export const projects: Project[] = [
  ...
  },
  {
    ...
    live: "https://crowdfunding-platform-taupe.vercel.app/",
  ...
  },
  {
    ...
    shortTitle: "SkillSphere",
    description:
      "A modern online learning platform where users can explore courses, view details, login/register, update profile information, and search courses by title. Features email/password authentication with Better Auth, Google social login, and persistent navbar and footer.",
    image: "/images/projects/skillsphere.PNG",
    tech: ["Next.js", "TypeScript", "Tailwind CSS", "DaisyUI", "Better Auth", "Prisma", "SQLite"],
    challenges: [
      "Implementing Better Auth with email/password and Google social login integration",
      "Building protected course details page with authentication state management",
      "Creating profile page with name and image URL update functionality",
      "Designing responsive homepage with hero section and popular courses based on rating",
    ],
    improvements: [
      "Add video streaming integration for course content delivery",
      "Implement progress tracking and certificates for completed courses",
      "Add course enrollment and payment integration with Stripe",
      "Build admin dashboard for course management and analytics",
    ],
    live: "https://skillsphere-sable.vercel.app/",
    github: "https://github.com/meheroon/skillsphere",
  },
];
